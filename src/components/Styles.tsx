        ...
        {styles.map((style, key) => (
          <li>
            <button
              ...
              className={` px-4 py-2 border-[#00000076] rounded-full  ${selectedButtonId === key ? "border-2 font-medium text-black" : "border text-[#00000076]"} duration-100 transition-all `}
            >
              {style}
            </button>
          </li>
