...
const $$Tables = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Furnitures", $$Furnitures, { "title": title, "description": description, "background": background, "styles": styles, "items": items })} ${renderScript($$result, "/Users/wiktordawid/Desktop/HebelMebel/HebelMebel/src/pages/tables.astro?astro&type=script&index=0&lang.ts")}`;
