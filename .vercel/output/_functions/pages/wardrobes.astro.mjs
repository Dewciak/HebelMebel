...
const $$Wardrobes = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<!-- komody -->${renderComponent($$result, "Furnitures", $$Furnitures, { "title": title, "description": description, "background": background, "styles": styles, "items": items })} ${renderScript($$result, "/Users/wiktordawid/Desktop/HebelMebel/HebelMebel/src/pages/wardrobes.astro?astro&type=script&index=0&lang.ts")}`;
